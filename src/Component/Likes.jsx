                          ...
                          <div className='head'>
                            <div> 
                               <div style={{display:"flex"}}>
                                 <img  style={{height:"55px",borderRadius:"50%",marginTop:"35px"}} src="data:image/png;base64,
                                 ...
                                 c74razzW0WztDwLp+9JY+aPdbDZZRWdpf8HyEhFj1gUF4YAAAAASUVORK5CYII="
                                  alt="user_icon" />
                                <span style={{fontSize:"20px" ,marginTop:"47px",marginLeft:"15px"}}>User_name</span>
                               </div>
