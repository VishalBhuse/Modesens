    ...
    <div>
        ...
        <div className={styles.profilebox}>
            ...
            <div>
              ...
              <h3 style={{textAlign:"left",fontWeight:"bold", marginLeft:"6%", marginTop:"10px"}}>Recent</h3>
            </div>
        ...
        <div className={styles.productbox}>
            {recentdata.map((el,index) => (
              <div className={styles.product} key={index}>
                ...
                <Link to={`/recent/recentquickview/${el.id}`}> <button onClick={onOpen} className={styles.quickbtn}>Quick View</button> </Link>
                 </div>
